#ifndef VISUALUNIQUE_H
#define VISUALUNIQUE_H
...
class VisualUnique : public VisualBase {
    Q_OBJECT
public:
    // 构造函数，初始化 UI 界面布局
    explicit VisualUnique(QWidget *parent = nullptr);
    // 执行动画的一步进操作
...
private:
    ...
    class CanvasWidget : public QWidget {
        VisualUnique* p;
    public:
        CanvasWidget(VisualUnique* parent) : QWidget(parent), p(parent) {}
    protected:
    ...
    std::vector<UniqueAnimStep> animSteps;
    int currentStep;
    void updateCodeBrowser(); // 更新高亮源码显示
};

#endif // VISUALUNIQUE_H
