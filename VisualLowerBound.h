#ifndef VISUALLOWERBOUND_H
#define VISUALLOWERBOUND_H
...
class VisualLowerBound : public VisualBase {
    Q_OBJECT
public:
    // 构造函数，初始化 UI 界面布局
    explicit VisualLowerBound(QWidget *parent = nullptr);
    // 执行动画的一步进操作
...
private:
    ...
    class CanvasWidget : public QWidget {
        VisualLowerBound* p;
    public:
        CanvasWidget(VisualLowerBound* parent) : QWidget(parent), p(parent) {}
    protected:
    ...
    std::vector<LBAnimStep> animSteps;
    int currentStep;
    void updateCodeBrowser(); // 更新高亮源码显示
};

#endif // VISUALLOWERBOUND_H
